...
<h2 style="text-align:center">EDIT FILES</h2>
...
<form:form class="form-horizontal" id="formRegister" data-toggle="validator" role="form" commandName="uploadform" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input name="title"  class="form-control" id="title" value="${u.title}" placeholder="Enter title" data-error="Enter valid Title" required>
    <div class="help-block with-errors"></div>
  </div>
  <div class="form-group">
    <label for="inputFirstName" class="control-label">URL_FRONT_PAGE</label>
    <input type="file" name="file1"  value="${u.fpage}" class="form-control" id="file"  data-error="should not be null upload only png,jpeg,jpg files" required>
    <div class="help-block with-errors"></div>
  </div>
  <div class="form-group">
    <label for="inputLastName" class="control-label">URL_FRONT_PAGE</label>
    <input type="file" name="file2" value="${u.bpage}"  class="form-control" id="file"  data-error="should not be null upload only png,jpeg,jpg files" required>
    <div class="help-block with-errors"></div>
  </div>
  <div class="form-group">
    <label for="search" class="control-label">SEARCH TAGS</label>
    <input type="text"  name="search" value="${u.search}" class="form-control" id="search" placeholder="Enter Search for Tags" data-error="should not be null" required>
    <div class="help-block with-errors"></div>
  </div>
