...
<h3 style="text-align:center">Welcome to DigiLocker</h3>
...
<form:form class="form-horizontal" id="formLogin" data-toggle="validator" role="form" commandName="loginForm">
  <div class="form-group">
    <label for="inputEmail" class="control-label">Email</label>
    <input name="useremail" type="text" class="form-control" id="useremail" placeholder="Enter Email" data-error="Enter valid Email" required>
    <div class="help-block with-errors"></div>
  </div>
  <div class="form-group">
    <label for="inputPassword" class="control-label">Password</label>
    <input type="password" name="password" class="form-control" id="password" placeholder="Enter Password" data-error="Password should not be null" required>
    <div class="help-block with-errors"></div>
  </div>
